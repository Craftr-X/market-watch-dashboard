...
[![AkShare](https://img.shields.io/badge/AkShare-数据源-blue)](https://github.com/akfamily/akshare)

本地运行的 A 股每日行情与强势观察 Web 工具，用于市场学习与收盘复盘，不提供买卖建议。

> 仓库地址：<https://github.com/Craftr-X/market-watch-dashboard>
...
- **数据存储**：SQLite
- **数据源**：[AkShare](https://github.com/akfamily/akshare)（新浪接口）
...
│   │   │   ├── StockHeader.tsx       # 个股头部
│   │   │   ├── StockToolbar.tsx      # 工具栏
│   │   │   ├── StatsPanel.tsx        # 统计面板
│   │   │   ├── SearchModal.tsx       # 搜索弹层
│   │   │   ├── WatchlistButton.tsx   # 收藏按钮
│   │   │   └── ErrorCard.tsx         # 错误卡片
│   │   ├── hooks/
│   │   │   ├── useStockHistory.ts    # 历史数据 hook
│   │   │   └── useSearch.ts          # 搜索 hook
│   │   ├── store/
│   │   │   └── watchlist.ts          # Zustand 自选股
│   │   ├── utils/
│   │   │   └── ma.ts                 # 均线计算
│   │   └── stock/[code]/
│   │       └── page.tsx              # 个股详情页
...
欢迎通过 Issue 或 Pull Request 反馈问题或提出改进建议。
